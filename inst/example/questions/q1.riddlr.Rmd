...
#
# One note, this is expected to be run in the topenv() upon riddlr attach,
# meaning that you should only expect that the standard library is available
#
# TODO: 
#   - allow for `library()` calls within grader functions to extend to new
#     packages
# 
